        ...
        <div class="box">
            <table border="1" cellspacing="9" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <th><?php echo $no++?></th>
                        <th><?php echo $row['kategori_nama']?></th>
                        <th>
                            <a href="edit-kategori.php?id=<?php echo $row['kategori_id']?>">Edit</a> || <a href="proses-hapus.php?idk=<?php echo $row['kategori_id']?>" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                        </th>
                    </tr><?php
                }}else{?>
                    <tr>
