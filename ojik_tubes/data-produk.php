            ...
            <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="produk/?php echo $row['produk_gambar'] ?>"><img src="produk/?php echo $row['produk_gambar'] ?>"></a></td>
                        <td><?php echo ($row['produk_status']==0)?'Tidak aktif':'aktif';?></th>
                        <td>
                            <a href="edit-produk.php?id=<?php echo $row['produk_id']?>">Edit</a> || <a href="proses-hapus.php?idp=<?php echo $row['produk_id']?>" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                        </td>
                    </tr><?php
                }}else{ ?>
                <tr>
