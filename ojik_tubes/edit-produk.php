    ...
    <div class="container">
        ...
        <div class="box">
           <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="harga" placeholder="Harga" class="input-control" value="<?php echo $p->produk_harga ?> "required>
            <img src="produk/<?php echo $p->produk_gambar ?>" width="100px">
            <input type="hidden" name="foto" value="<?php echo $p->produk_gambar ?>">
            <input type="file" name="gambar" class="input-control" >
            <textarea name="deskripsi" placeholder="Deskripsi" class="input-control"><?php echo $p->produk_desk ?></textarea>
