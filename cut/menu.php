...
<body>
    ...
    <div class="wrap"><a href="tambah.php"><button type="button" class="btn btn-block btn-primary"
            style="width:120px;margin: 20px 0 10px 25px;">Tambah data SPP + </button></a></div>
    <div class="wrap" style=" justify-content:center; margin:30px;">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <?php
                    $no = 1;
                    $data = mysqli_query($conn,"select * from kaka order by k_kk asc");
                    if(mysqli_num_rows($data)){
                      while($baris = mysqli_fetch_array($data)){?>
                                <tr>
                                    <td><?php echo $no++ ?></td>
                                    <td><?php echo $baris['nokk']?></td>
                                    <td><?php echo $baris['k_kk'] ?></td>
                                    <td><span class="tag tag-success"><?php echo $baris['jumlah_kk'] ?></span></td>
                                ...
                                <tr style="text-align:center;">
                                    <td colspan="5" style="background-color: green; color: white;">tidak ada data yang
                                        ditampilkan</td>
                                </tr>
                                <?php } ?>
                            </tbody>
